...
11. Change the `path` variable to the path to the folder `stored_outputs_train` and the `save_path` variable to the folder where you want to store the final segmentations.
