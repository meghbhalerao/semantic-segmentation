...
seg_pred1 = seg_pred1.cpu().detach().numpy()
seg_pred2 = seg_pred2.cpu().detach().numpy()
seg_pred3 = seg_pred3.cpu().detach().numpy()
seg_pred4 = seg_pred4.cpu().detach().numpy()
seg_pred5 = seg_pred5.cpu().detach().numpy()

seg_pred1 = (seg_pred1>0.5).astype(int)
seg_pred2 = (seg_pred2>0.5).astype(int)
seg_pred3 = (seg_pred3>0.5).astype(int)
seg_pred4 = (seg_pred4>0.5).astype(int)
seg_pred5 = (seg_pred5>0.5).astype(int)

seg_acc = seg_pred1 + seg_pred2 + seg_pred3 + seg_pred4 + seg_pred5

seg = (seg_acc>2.5).astype(int)
seg = seg[0]
